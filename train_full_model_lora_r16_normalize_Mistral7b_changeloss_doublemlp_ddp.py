...
class Config:
    ...
    OUTPUT_DIR = "output/all_model_LoRA_attention_right_label_r16_normalize_mistral7b_changeloss_doublemlp"
...
class LingoAuraLLM(nn.Module):
    def __init__(self, config):
        ...
        lora_config = LoraConfig(
            ...
            r=32,  # Mistral容量更大，可适当增大r值（16→32）
            lora_alpha=64,
            # Mistral的注意力层命名为q_proj、k_proj、v_proj、o_proj
    ...
    def forward(self, input_ids, attention_mask, labels, visual_features, acoustic_features):
        ...
        total_loss = lm_loss + 0.1 * contrast_loss  # 加权融合
        return total_loss
